    ...
    return (
        <Section id={props.title}>
            ...
            <BodyText>
                ...
                <a href="https://cabanadesignsystem.com">Cabana Sketch Library</a>, these styles will have been set up
                in the library. The library file is similar to a 'config' file for developers. It contains most of the
                main definitions of visual styles including:
            </BodyText>
            <BodyText is="ul">
                <li>Color pallete</li>
