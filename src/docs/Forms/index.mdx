...
>
    ...
    <TextInput borderColor="success" color="success" defaultValue="Success" />
    ...
    <div>
        ...
        <TextInput borderColor="error" name="textInput" my="4px" />
        <ValidationLabel>This is a required field</ValidationLabel>
    </div>
    <div>
        <FormLabel htmlFor="textInput2">Phone Number</FormLabel>
        <TextInput borderColor="success" name="textInput2" defaultValue="(015) 2323 2320" my="4px"/>
